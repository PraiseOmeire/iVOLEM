    ...
    <footer className="bg-gray-900 text-white">
      <Container className="py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">
              A welcoming community where faith comes alive.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {serviceTimes.map((service) => (
                <li key={service.day} className="text-gray-300">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <a
                  href="mailto:info@fulllifeassembly.org"
                  className="hover:text-primary transition-colors"
                >
                  info@fulllifeassembly.org
                </a>
              </li>
            </ul>
            {/* Social Media */}
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>
            &copy; {new Date().getFullYear()} Full Life Assembly. All rights
            reserved.
          </p>
        </div>
      </Container>
